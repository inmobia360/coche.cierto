...
| Commit de referencia | `798a1cc` — versión beta desplegada y marcada como buena |
...
| Instrucción | Todos los agentes deben partir de `main@798a1cc` y no reabrir versiones anteriores |
