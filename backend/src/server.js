...
app.post('/api/dealer-request-pdf', async (req, res) => {
  ...
  const translations = { high: 'alto', medium: 'medio', low: 'bajo', mixed: 'mixto', 'three-four': 'tres o cuatro', repairs: 'facilidad de reparación', sometimes: 'a veces', always: 'habitualmente', never: 'nunca', private: 'particular', professional: 'profesional', '0-3': 'En los próximos 3 meses', '3-6': 'Entre 3 y 6 meses', '6+': 'Más adelante', unknown: 'Por concretar' };
