document.addEventListener('DOMContentLoaded', function () {
  ...
  modal.innerHTML = '<div class="valuator-backdrop" data-close-valuator></div><div class="valuator-dialog"><button class="valuator-close" type="button" aria-label="Cerrar valoración">×</button><p class="eyebrow">CocheCierto Decide · 5 minutos</p><h2 id="valuatorModalTitle">¿Qué quieres resolver primero?</h2><div class="modal-choices"><button class="mini-choice selected" data-modal-intent="buy" type="button" aria-pressed="true">Quiero comprar</button><button class="mini-choice" data-modal-intent="change" type="button" aria-pressed="false">Voy a cambiar de coche</button><button class="mini-choice" data-modal-intent="inform" type="button" aria-pressed="false">Todavía estoy explorando</button></div><button class="button mini-submit" id="modalStart" type="button">Crear mi valoración</button><p class="mini-note">Sin registro para empezar · Verás una orientación antes de pedirte el email</p></div>';
