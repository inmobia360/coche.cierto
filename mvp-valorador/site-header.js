const start=()=>{
  ...
  style.textContent += '.app{max-width:1280px}.app #screen{max-width:920px;margin:36px auto 0}.demo-app{max-width:1280px}@media(max-width:620px){.app #screen{margin-top:24px}}';
