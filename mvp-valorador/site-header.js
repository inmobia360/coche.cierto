document.addEventListener('DOMContentLoaded',()=>{
  ...
  header.innerHTML='<a class="site-brand" href="../" aria-label="CocheCierto, inicio"><img src="../brand-symbol.svg" alt=""><span>Coche<strong>Cierto</strong></span></a><nav class="site-nav" aria-label="Navegación principal"><a href="../como-funciona/">Cómo funciona</a><a href="../recursos/">Qué analizamos</a><a href="../demo/">Informe de ejemplo</a><a href="../metodologia/">Metodología</a></nav><a class="site-cta" href="../valorador/">Empezar diagnóstico</a><button class="site-menu-toggle" type="button" aria-expanded="false" aria-label="Abrir menú">☰</button>';
  page.prepend(header);
